        ...
        while self._run_flag:
            ...
            try:
                ...
                while self._run_flag:
                    ...
                    if not self.is_thermal and self.parent_ui.calibrated_hotspot_coords:
...
class PTZControlApp(QWidget):
    def __init__(self):
        ...
        self.ptz_limits = {'pan_min': -1.0, 'pan_max': 1.0, 'tilt_min': -1.0, 'tilt_max': 1.0}
    ...
    def init_onvif(self):
        try:
            ...
            print(f"ONVIF bağlantı/limit alma hatası: {e}. Varsayılan 0-360° ve -90-90° limitleri kullanılacak.")
            self.ptz_limits = {'pan_min': 0, 'pan_max': 360, 'tilt_min': -90, 'tilt_max': 90}
            if self.ptz is None: print("PTZ kontrolü kullanılamıyor.")
    ...
    def update_thermal_data(self, data):
        try:
            ...
            if hotspot_node:
                self.calibrated_hotspot_coords = (hotspot_node.get('positionX', 0), hotspot_node.get('positionY', 0))
        except Exception as e:
