        ...
        while self._run_flag:
            ...
            try:
                ...
                while self._run_flag:
                    ...
                    # DÜZELTME: Görüntünün 2D (gri) mi 3D (renkli) mi olduğunu kontrol et
                    if frame is None:
                        continue
                    ...
                    if self.is_thermal:
                        # Termal görüntü üzerinde imleçleri ve sıcaklıkları göster
                        ...
                        # Normal görüntü üzerinde termal kameranın görüş alanını (ROI) çiz
