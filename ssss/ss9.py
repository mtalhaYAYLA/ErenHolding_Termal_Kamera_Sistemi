...
class PTZControlApp(QWidget):
    ...
    def update_thermal_coloring_rules(self):
        ...
        try:
            ...
            if response_get.status_code != 200:
                print(f"Mevcut kurallar alınamadı: {response_get.status_code}")
                return
            ...
            response_put = requests.put(THERMAL_ALARM_RULES_URL, auth=self.auth, data=updated_xml, headers=headers, timeout=3)
    ...
    def get_calibrated_point(self, thermal_x, thermal_y, point_type):
        ...
        try:
            ...
            # Hata durumunda basit oranlamayı kullan
